...
export default function ScrollIndicator({ scrollYProgress }) {
  ...
  return (
    <motion.div
      style={{ opacity }}
      className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-30 pointer-events-none flex flex-col items-center gap-2 translate-z-0 will-change-transform"
    >
